...
Module MemoryLemmas.
  ...
  Lemma setN_inside: forall (vl : list memval) (c : Maps.ZMap.t memval) (ofs0 ofs: Z),
      Intv.In ofs0 (ofs, (ofs + Z.of_nat (length vl))%Z) ->
      Maps.ZMap.get ofs0 (Mem.setN vl ofs c) = List.nth (Z.to_nat (ofs0 - ofs)%Z) vl Undef.
  Proof.
    intros vl.
    ...
    - simpl in *.
      ...
      destruct (Maps.ZIndexed.eq ofs0 (ofs + Z.of_nat (length vl))). subst.
